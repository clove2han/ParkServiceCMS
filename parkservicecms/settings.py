#_*_coding:utf-8_*_
"""
Django settings for parkservicecms project.
...
ROOT_URLCONF = 'parkservicecms.urls'
...
WSGI_APPLICATION = 'parkservicecms.wsgi.application'
